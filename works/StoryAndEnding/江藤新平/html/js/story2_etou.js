...
$(function(){
    $('.butom_2').click(function(){
        $('.comentin').text(text1),$('.nametitle').text("江藤 新平").css("box-shadow","0px 3px 10px 2px gray").css("border","solid white").css("background-color","white").css("font-size","4vmin"),$('.human').html("<img src='../../../TopAndKyara/etou.png'>")
        $('.butom_2').click(function(){
                                    ...
                                    $('.butom_2').click(function(){
                                        ...
                                        $('.butom_2').click(function(){
                                            ...
                                            $('.butom_2').click(function(){
                                                ...
                                                $('.butom_2').click(function(){
                                                    $('.comentin').text(text12),$('.nametitle').text("江藤 新平").css("box-shadow","0px 3px 10px 2px gray").css("border","solid white").css("background-color","white").css("font-size","4vmin"),$('.human').html("<img src='../../../TopAndKyara/etou.png'>")
                                                    $('.butom_2').click(function(){
