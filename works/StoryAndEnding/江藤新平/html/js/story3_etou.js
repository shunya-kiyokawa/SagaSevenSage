...
$(function(){
    $('.butom_2').click(function(){
        ...
        $('.butom_2').click(function(){
            $('.comentin').text(text2),$('.nametitle').text("江藤 新平"),$('.human').html("<img src='../../../TopAndKyara/etou.png'>")
            $('.butom_2').click(function(){
                                        ...
                                        $('.butom_2').click(function(){
                                            ...
                                            $('.butom_2').click(function(){
                                                ...
                                                $('.butom_2').click(function(){
                                                    ...
                                                    $('.butom_2').click(function(){
                                                        $('.comentin').text(text13),$('.nametitle').text("江藤 新平"),$('.human').html("<img src='../../../TopAndKyara/etou.png'>")
                                                        $('.butom_2').click(function(){
